...
Page({
  ...
  goLogin() {
    ...
    let data={
      ...
      jpush_id: 'wechat app',
      unionId: wx.getStorageSync('unionId'),//app.globalData.userInfo.unionId,
    ...
    AJAX('/apiwrite/user/login',data,function(res){
      ...
      if (res.error_code === 2000) {
        ...
        wx.setStorageSync('userPhone', _this.data.phoneNum)
  ...
  phoneLogin() {
    ...
    if (!/^1(3|4|5|6|7|8|9)\d{9}$/.test(this.data.phoneNum.trim())) {
      _this.showToast('请输入正确的手机号码')
      return false
